...
def visualize_artifacts(artifacts, output_dir: str) -> None:
        ...
        if artifact.type_name == 'ExampleStatistics':
            for split in artifact_utils.decode_split_names(artifact.split_names):
                ...
                if artifact_utils.is_artifact_version_older_than(
                        artifact, artifact_utils._ARTIFACT_VERSION_FOR_STATS_UPDATE):
                ...
                # Export as html file
                with open(os.path.join(output_path, f'{split}_statistics.html'), 'w') as file:
                    file.write(html)
            ...
            for split in artifact_utils.decode_split_names(artifact.split_names):
                ...
                if artifact_utils.is_artifact_version_older_than(
                        artifact, artifact_utils._ARTIFACT_VERSION_FOR_ANOMALIES_UPDATE):
                ...
                # Export as html file
                with open(os.path.join(output_path, f'{split}_anomalies.html'), 'w') as file:
                    file.write(html)
