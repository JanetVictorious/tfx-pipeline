...
# # Relax the minimum fraction of values that must come from the domain for the feature `Age`
# age_feature = tfdv.get_feature(schema, 'Age')
# age_feature.distribution_constraints.min_domain_mass = 0.8

# Relax the minimum fraction of values that must come from the domain for the feature `Embarked`
...
tfdv.set_domain(schema, 'Age', schema_pb2.FloatDomain(name='Age', min=0.0, max=81.0))
